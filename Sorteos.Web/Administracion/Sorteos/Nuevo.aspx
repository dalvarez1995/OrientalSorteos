<%@ Page Title="Sorteos Oriental - Crear Sorteo" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" ValidateRequest="false" Inherits="Sorteos.Web.Administracion.Sorteos.Nuevo" %>

<asp:Content ID="nuevoSorteoHead" ContentPlaceHolderID="header" runat="server">
</asp:Content>
<asp:Content ID="nuevoSorteoContent" ContentPlaceHolderID="content" runat="server">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 justify-content-center text-center">
                                <button id="btnIngresar" type="submit" onserverclick="btnIngresar_ServerClick" runat="server" class="btn btn-primary"><i class="fa fa-save m-r-sm"></i>Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="nuevoSorteoBody" ContentPlaceHolderID="body" runat="server">
